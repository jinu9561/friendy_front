...
const SendReport = ({ commBoardSeq, postUserSeq, onReportSent }) => {
    ...
    useEffect(() => {
        const report = async () => {
            ...
            const reportData = {
                ...
                reportType: {
                    reportType: "community_boards",
                    seqByType: parseInt(commBoardSeq)
                }
            };
        ...
        report();
    }, [commBoardSeq, postUserSeq, onReportSent]); // 의존성 배열에 변수들 추가
